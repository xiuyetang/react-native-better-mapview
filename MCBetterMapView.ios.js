...
var MapView = React.createClass({
    ...
    render: function() {
        return <MCBetterMapView {...this.props} onPress={this._onPress} onChange={this._onChange} />;
    },
});

if (Platform.OS === 'android') {
    var MCBetterMapView = createReactNativeComponentClass({
        ...
        uiViewClassName: 'MCBetterMapView',
    });
} else {
    var MCBetterMapView = requireNativeComponent('MCBetterMapView', MapView);
}
